...
../nebula --read-xyz IN/cube.xyz 1 --position-scaling 2 2 2 --read-xyz IN/cube.xyz 1 --write-xyz OUT/decimated_xyz_cubes.xyz
../nebula --read-xyz IN/cube.xyz 1 --position-scaling 2 2 2 --read-xyz IN/cube.xyz 1 --write-obj OUT/triangulated_xyz_cubes.obj
